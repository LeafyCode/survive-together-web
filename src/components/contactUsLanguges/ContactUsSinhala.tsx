            ...
            <STPageContainer className="container">
                <STPageContentWrapper>
                    <ContactContent className="content">
                        <p>
                            <a href="mailto:hello@leafycode.com">hello@leafycode.com</a>&nbsp;වෙත විද්‍යුත් තැපෑලක් එවීමෙන් හෝ ෆේස්බුක්&nbsp;
                            <a
                                target="_blank"
                            ...
                            </a>&nbsp;හරහා පණිවුඩයක් යැවීමෙන් ඔබට Survive Together පිටුපස සිටින කණ්ඩායම සම්බන්ධ කර ගත හැකිය.
                        </p>
